...
This repository intends to supply students, that are about to start developing research, with "research plan templates", including a [Beamer-based presentation template](https://github.com/dloubach/research-plan-templates/tree/master/beamer-slides).
